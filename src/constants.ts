...
export const PHONE_DISPLAY = '+33 7 62 69 93 16';
export const PHONE_HREF = 'tel:+33762699316';
export const LOCATION = 'Remote · France entière';
export const GITHUB_URL = 'https://github.com/gabbloquet';
export const LINKEDIN_URL = 'https://www.linkedin.com/in/gabin-bloquet';
