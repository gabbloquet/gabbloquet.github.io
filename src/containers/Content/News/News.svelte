...
<section class="white-card" id="news">
  <div class="news" >
    ...
    <p>Je suis profondément passionné par la qualité, la co-création du produit avec ses utilisateurs, l'architecture, les débats techniques, l'approche fonctionnelle, le "Separation of concerns", la réutilisabilité... (Tout ce qui touche à la qualité du code, sa compréhension, sa lisibilité, sa capacité à pouvoir le faire évoluer facilement).
