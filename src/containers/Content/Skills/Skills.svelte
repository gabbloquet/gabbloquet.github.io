...
<article class="skills" id="skills">
  ...
  <article class="skills-content">
    <header>
      ...
      <div class="back">
        <img src="https://docs.microsoft.com/fr-fr/dotnet/architecture/cloud-native/media/backend-for-frontend-pattern.png" alt="backend developement (Secure, scalable...)"/>
        <h2>Back</h2>
        <h3>Langages</h3>
      ...
      <div class="ops">
        <img src="https://d33wubrfki0l68.cloudfront.net/2475489eaf20163ec0f54ddc1d92aa8d4c87c96b/e7c81/images/docs/components-of-kubernetes.svg" alt="autres compétences (agilité, créativité, ouverture...)"/>
        <h2>Ops</h2>
        <h3>Cloud provider</h3>
        <p>Google cloud platform</p>
        <h3>Outils de déploiement</h3>
        <p>Kubernetes, Flux & Helm</p>
        <h3>CI/CD</h3>
        <p>Jenkins</p>
      </div>
    </header>
